...
const BooksClient: React.FC<BooksClientProps> = ({ data }) => {
  ...
  return (
    <>
      <AddBookModal open={addModal} onClose={() => setAddModal(false)} />

      <div className="flex items-center justify-between mb-8">
        <Heading title="Books Page" description="Manage books details" />
        <div className="flex gap-5">
          ...
          >
            ...
            <span className="ml-4 hidden sm:inline"> Add Book </span>
          </Button>
        </div>
      </div>
      <Form {...searchForm}>
